...
# System prompt template for document-aware queries
DOCUMENT_QUERY_PROMPT = """The user has a question:
<query>
{query}
</query>
...
class ChatService(Chat):
    def __init__(
        ...
        ai_service: Union[Claude, GroqClient],
    ):
        super().__init__(clients=clients, ai_service=ai_service)
    ...
    async def _process_query(self, query: str):
        ...
        prompt = DOCUMENT_QUERY_PROMPT.format(query=query, resources=added_resources)
